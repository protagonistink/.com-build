  ...
  return (
    ...
    >
      ...
      {hasImage && (
        <>
          <div
            className="absolute inset-0 opacity-0 group-hover:opacity-80 transition-opacity duration-700 ease-out"
          >
            <Image
              src={post.mainImage!}
              alt=""
          ...
          <div
            className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/50 to-black/30 opacity-0 group-hover:opacity-100 transition-opacity duration-700 ease-out"
          />
        </>
      )}
      ...
      <div
        className={`absolute -right-4 top-1/2 -translate-y-1/2 font-serif text-[10rem] md:text-[12rem] italic pointer-events-none select-none text-ink/[0.03] group-hover:-translate-x-6 transition-all duration-700 ease-out ${
          hasImage
            ? 'group-hover:text-warmwhite/[0.06]'
            : 'group-hover:text-ink/[0.07]'
        }`}
      >
        {num}
      </div>
